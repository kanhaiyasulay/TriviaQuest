...
public class TriviaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<Question>().HasData(
            new Question { Id = 1, Text = "What is the capital of France?", Explanation = "Paris is capital of France", CategoryId = 1, Difficulty = Difficulty.Medium },
            new Question { Id = 2, Text = "Who directed 'Inception'?", Explanation = "Christopher Nolan was director", CategoryId = 2, Difficulty = Difficulty.Hard },
            new Question { Id = 3, Text = "Which company makes the PlayStation?", Explanation = "Sony makes since 1994", CategoryId = 3, Difficulty = Difficulty.Easy }
        );
